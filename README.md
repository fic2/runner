...
Docker is very popular, and there are more than 70,000 Dockerized applications at the DockerHub Registry: [*https://registry.hub.docker.com/*](https://registry.hub.docker.com/)
...
[*https://registry.hub.docker.com/repos/fic2/*](https://registry.hub.docker.com/repos/fic2/)

![](images/image1.png)

<span id="_Toc419306975" class="anchor"></span>Figure 4 - The FI-CONTENT 2 public repository of Docker images
...
<span id="_Toc419306976" class="anchor"></span>Figure 5 - FIWARE Lab portal to sign up and request community upgrade

Once you have received a confirmation of your upgrade to a community account, you can go to the FIC2Lab runner wizard at [*https://runner.developer.mediafi.org*](https://runner.developer.mediafi.org) where you will be guided through the steps to create your own run environment.
...
<span id="_Toc419306977" class="anchor"></span>Figure 6 - FIC2Lab runner (beta) - Landing page
...
<span id="_Toc419306978" class="anchor"></span>Figure 7 - FIC2Lab runner (beta) - Deployment wizard
...
<span id="_Toc419306979" class="anchor"></span>Figure 8 - FIC2Lab runner (beta) - User-dedicated management console
...
<span id="_Toc419306980" class="anchor"></span>Figure 9 - FIC2Lab runner (beta) - Social Network Enabler SE launched from the console
...
<span id="_Toc419306981" class="anchor"></span>Figure 10 - FIC2Lab runner (beta) - Changing port mapping of the SNE SE instance
...
If you are familiar with Docker, you can find the Docker images and the instructions in the FIC2Lab DockerHub repository: [*https://registry.hub.docker.com/repos/fic2/*](https://registry.hub.docker.com/repos/fic2/)
...
To get it running on your machine, follow the Docker installation instructions: [*http://docs.docker.com/installation/*](http://docs.docker.com/installation/).

Under Mac OS X, you can use Kitematic, a nice user interface (also installs VirtualBox with a guest Linux): [*http://kitematic.com*](http://kitematic.com)

You can also deploy it to different Cloud providers easily using Docker Machine: [*https://docs.docker.com/machine/*](https://docs.docker.com/machine/)
...
Find your SE on the public FI-CONTENT 2 repository [*https://registry.hub.docker.com/repos/fic2/*](https://registry.hub.docker.com/repos/fic2/)
...
a12d72b85f09 fic2/ppnet:latest "/usr/local/bin/run. 44

seconds ago Up 43 seconds 0.0.0.0:8000-\>80/tcp
...
<span id="_Toc419306985" class="anchor"></span>Figure 14 - Configuring the security group rules for docker-machine
...
-   tenant ID: upon connecting to the Cloud Portal, retrieve the ID at the bottom of the screen in the message “Connected to project your-name cloud (ID 00000000000000000000000000001234)”

-   region: the region where your Community account has the right to allocate instances and public IPs, e.g. Lannion2

### Setting up the tools

1.  Install Docker Machine following the instructions: [*https://docs.docker.com/machine/\#installation*](https://docs.docker.com/machine/#installation)

2.  Load the environment variables to target the FIWARE Lab node, e.g.:

export OS\_REGION\_NAME=Lannion2

export OS\_TENANT\_ID=00000000000000000000000000001234
...
a12d72b85f09 fic2/ppnet:latest "/usr/local/bin/run. 29

seconds ago Up 28 seconds 0.0.0.0:32768-\>80/tcp
...
Kitematic ([*www.kitematic.com*](http://www.kitematic.com)) is a OS X application to simplify the use of docker. By default, it uses docker-machine to create a Linux instance using VirtualBox in the local OS X machine and deploy Docker containers in it.
...
<span id="_Toc419306986" class="anchor"></span>Figure 15 - Searching the DockerHub repositories using Kitematic

![](images/image13.png)

<span id="_Toc419306987" class="anchor"></span>Figure 16 - Downloading and launching ppnet using Kitematic

![](images/image14.png)

<span id="_Toc419306988" class="anchor"></span>Figure 17 - ppnet up and running using Kitematic: logs and web preview

Kitematic has a button (4th at the top) to open a terminal in the target machine to use the Docker command-line client.

![](images/image15.png)

<span id="_Toc419306989" class="anchor"></span>Figure 18 - Accessing a terminal on the host machine from Kitematic
